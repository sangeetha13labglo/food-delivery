...
export default function ManagerRegister() {
  ...
  const handleAnotherChange = (e) => {
    setAnother({ ...another, "is_manager": is_manager, [e.target.name]: e.target.value });
  }
  ...
  const handleClick = () => {
    ...
    else if (another.birth_date === "") {
      inputRef.current.birth_date.focus();
    }
    ...
    axios.post(baseUrl("/manager/register/"), { ...apidata, "profile": another })
  ...
  return (
    <div>
      <center>
        <Card sx={{ width: "500px", marginTop: "100px", backgroundColor: "lightblue", borderRadius: "20px" }}>
          <h1>Register</h1>
          <TextField
            name="username"
            type="text"
          ...
          <TextField
            ...
            inputLabelProps={{ shrink: true }}
            inputRef={(ref) => (inputRef.current.address)}
            onChange={handleAnotherChange}
            required
          /><br /><br />
